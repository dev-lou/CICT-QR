...
export default function AdminPointTally({ isPublic = false, onLogout, onNavigateScanner, onNavigateManageData, onNavigateAudit, onNavigateHistory, onNavigateTeamExport }) {
